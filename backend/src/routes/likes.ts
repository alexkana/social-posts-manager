...
import { likePostController, unlikePostController, getLikedPostsController, clearAllLikedPostsController } from '../controllers/likeController';
import { validate } from '../middleware/validation';
import { 
  likePostValidation,
} from '../validators/likeValidators';
...
// @desc    Like a post
// @access  Private
router.put('/:id', auth, likePostValidation, validate, likePostController as RequestHandler);
